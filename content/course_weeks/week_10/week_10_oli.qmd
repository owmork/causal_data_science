...
linktitle: "10 - Regression Discontinuity"
output:
  blogdown::html_page:
    toc: true
menu:
...
[**Task 5:**]{style="color:#FF7E15"} Including covariates, run an event study and assess whether the assumption of parallel trends holds.
...
# (a) Sun-Abraham
sunab <- fixest::feols(minutes_watched ~ sunab(group, time) + age + gender + account_tenure + num_drama_watched + num_comedy_watched + num_action_watched | unit + time, data = stream)
summary(sunab)
fixest::iplot(sunab)
